...
describe 'Default config'
    ...
    context 'has <Plug> mappings'
        it 'for f'
            ...
            Expect maparg('<Plug>(emotions-f)', 'o') == ":<C-U>call emotions#search_for_characters({'direction': 'forward', 'scope': 'direction', 'include_destination': 1, 'character_count': 1})<CR>"
            Expect maparg('<Plug>(emotions-f)', 'v') == ":<C-U>call emotions#search_for_characters({'direction': 'forward', 'scope': 'direction', 'include_destination': 1, 'character_count': 1})<CR>"
        end
        ...
        it 'for F'
            ...
            Expect maparg('<Plug>(emotions-F)', 'o') == ":<C-U>call emotions#search_for_characters({'direction': 'backward', 'scope': 'direction', 'include_destination': 1, 'character_count': 1})<CR>"
            Expect maparg('<Plug>(emotions-F)', 'v') == ":<C-U>call emotions#search_for_characters({'direction': 'backward', 'scope': 'direction', 'include_destination': 1, 'character_count': 1})<CR>"
        end
        ...
        it 'for t'
            ...
            Expect maparg('<Plug>(emotions-t)', 'o') == ":<C-U>call emotions#search_for_characters({'direction': 'forward', 'scope': 'direction', 'include_destination': 0, 'character_count': 1})<CR>"
            Expect maparg('<Plug>(emotions-t)', 'v') == ":<C-U>call emotions#search_for_characters({'direction': 'forward', 'scope': 'direction', 'include_destination': 0, 'character_count': 1})<CR>"
        end
        ...
        it 'for T'
            ...
            Expect maparg('<Plug>(emotions-T)', 'o') == ":<C-U>call emotions#search_for_characters({'direction': 'backward', 'scope': 'direction', 'include_destination': 0, 'character_count': 1})<CR>"
            Expect maparg('<Plug>(emotions-T)', 'v') == ":<C-U>call emotions#search_for_characters({'direction': 'backward', 'scope': 'direction', 'include_destination': 0, 'character_count': 1})<CR>"
        end
    end
end
