...
let s:mapping_info = {
    ...
    \ 'search_for_last_search': {
        \ 'base_mappings': {
            ...
            \ 'n-relative': { 'direction': 'same'},
            \ 'N-relative': { 'direction': 'reverse'},
        \ },
        \ 'default_args': {
            \ 'include_destination': 0,
            \ 'scope': 'direction',
        \ },
        \ 'modifiers': {
            \ 'full':   { 'scope': 'window'},
    ...
    \ 'search_using_pattern': {
        \ 'base_mappings': {
            \ 'w':       { 'direction': 'forward',  'pattern': s:patterns.word_start},
            \ 'W':       { 'direction': 'forward',  'pattern': s:patterns.WORD_start},
            \ 'e':       { 'direction': 'forward',  'pattern': s:patterns.word_end},
            \ 'E':       { 'direction': 'forward',  'pattern': s:patterns.WORD_end},
            \ 'b':       { 'direction': 'backward', 'pattern': s:patterns.word_start},
            \ 'B':       { 'direction': 'backward', 'pattern': s:patterns.WORD_start},
            \ 'ge':      { 'direction': 'backward', 'pattern': s:patterns.word_end},
            \ 'gE':      { 'direction': 'backward', 'pattern': s:patterns.WORD_end},
            \ 'w-text':  { 'direction': 'forward',  'pattern': s:patterns.text_start},
            \ 'e-text':  { 'direction': 'forward',  'pattern': s:patterns.text_end},
            \ 'b-text':  { 'direction': 'backward', 'pattern': s:patterns.text_start},
            \ 'ge-text': { 'direction': 'backward', 'pattern': s:patterns.text_end},
        \ },
        \ 'default_args': {
            \ 'include_destination': 0,
            \ 'match_length': 1,
